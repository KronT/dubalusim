...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        self.failUnless(
            isinstance(
                get_backend(
                    'dfw.registration.backends.default.DefaultBackend'),
                DefaultBackend))
    ...
    def test_backend_error_invalid(self):
        ...
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'dfw.registration.backends.doesnotexist.NonExistentBackend')
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'dfw.registration.backends.default.NonexistentBackend')
...
class DefaultRegistrationBackendTests(TestCase):
    ...
    def test_valid_activation(self):
        ...
        self.assertEqual(activated.email, valid_user.email)
    ...
    def test_form_class(self):
        ...
        ``dfw.registration.forms.RegistrationForm``.

        """
        self.failUnless(self.backend.get_form_class(
            _mock_request()) is forms.RegistrationForm)
    ...
    def test_registration_signal(self):
        ...
        def receiver(sender, **kwargs):
            ...
            self.assertEqual(kwargs['user'].email, 'bob@example.com')
        ...
        signals.user_registered.disconnect(receiver, sender=self.backend.__class__)
    ...
    def test_activation_signal_success(self):
        ...
        signals.user_activated.disconnect(receiver, sender=self.backend.__class__)
...
class SimpleRegistrationBackendTests(TestCase):
    ...
    def test_post_activation_redirect(self):
        ...
        User = get_user_model()
        self.assertRaises(
            NotImplementedError, self.backend.post_activation_redirect,
