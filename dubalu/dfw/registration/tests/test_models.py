...
class RegistrationModelTests(TestCase):
    ...
    """
    alice_info = {'username': 'alice',
                 'password': 'swordfish',
                 'email': 'alice@example.com'}

    bob_info = {'username': 'bob',
                'password': 'secret',
    ...
    def test_profile_creation(self):
        ...
        """
        User = get_user_model()
        new_user = User.objects.create_user(**self.alice_info)
    ...
    def test_activation_email(self):
        ...
        self.assertEqual(mail.outbox[0].to, [self.alice_info['email']])
    ...
    def test_expired_activation(self):
        ...
        new_user = User.objects.get(**{username_field_name: self.alice_info[username_field_name]})
        self.failIf(new_user.is_active)
    ...
    def test_expired_user_deletion(self):
        ...
        self.assertEqual(RegistrationProfile.objects.count(), 1)
        username_field_name = getattr(User, 'USERNAME_FIELD', 'username')
        self.assertRaises(User.DoesNotExist, User.objects.get, **{username_field_name: self.bob_info[username_field_name]})
