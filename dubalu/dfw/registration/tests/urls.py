...
from ..views import register, direct_to_template
...
urlpatterns = patterns('',
    ...
    # name.
    url(
        r'^activate-with-template-name/(?P<activation_key>\w+)/$',
        activate,
        {
            'template_name': 'registration/test_template_name.html',
            'backend': 'dfw.registration.backends.default.DefaultBackend',
        },
    ...
    url(
        r'^activate-extra-context/(?P<activation_key>\w+)/$',
        activate,
        {
    ...
    url(
        r'^activate-with-success-url/(?P<activation_key>\w+)/$',
        activate,
        {
    ...
    # closed registration.
    url(
        r'^register-with-disallowed-url/$',
        register,
        {
    ...
    (r'', include('dfw.registration.backends.default.urls')),
)
